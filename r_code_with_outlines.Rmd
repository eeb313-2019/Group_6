...
# 8)	Mixed model to measure significance of environmental variables species evenness  
o	Need to account for spatial autocorrelation from step 7 
o	Model structure will depend on results from step 1, 2

# 9)	Mixed model to measure significance of environmental variables species richness  
o	Need to account for spatial autocorrelation from step 6 
o	Model structure will depend on results from step 1, 2
